...
- **Commit:** `a97bbb8` — `notifications: send push for proof and result actions` (follow-ups: `3d8fb54`, `f47040d` — build log only)
- **Push:** `git push origin main` — succeeded (tip `f47040d` after log edits)
