...
- **Commit:** `d430245` — `mobile: wire home proof actions to events`; `bc37e53` / `913ff27` / `1c771eb` — follow-up docs on this session
- **Push:** `git push origin main` — succeeded (`main` at `1c771eb`)
