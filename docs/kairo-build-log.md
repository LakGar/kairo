...
- **Commit:** `d430245` — `mobile: wire home proof actions to events`; `bc37e53` / `913ff27` — follow-up docs on this session
- **Push:** `git push origin main` — succeeded (`main` at `913ff27` after doc commits)
