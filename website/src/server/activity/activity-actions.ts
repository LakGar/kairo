...
export const ActivityAction = {
  ...
  MATCH_TEAM_RESULT_SUBMITTED: "MATCH_TEAM_RESULT_SUBMITTED",
  MATCH_TEAM_RESULT_CONFIRMED: "MATCH_TEAM_RESULT_CONFIRMED",
  MATCH_TEAM_RESULT_DISPUTED: "MATCH_TEAM_RESULT_DISPUTED",
